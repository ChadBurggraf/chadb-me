...
Blue Collar is a system for creating, managing, and executing background work in .NET applications. It includes an embedded web-based management interface, is data storage agnostic, can be installed via NuGet, a standard Windows Installer installation package, or by direct binary download.
